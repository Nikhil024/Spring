...
CREATE TABLE USERDETAILS (ID INT REFERENCES USERS(ID) PRIMARY KEY,FNAME VARCHAR2(700),LNAME VARCHAR2(700),EMAIL VARCHAR2(900),ADDRESS VARCHAR2(999),CITY VARCHAR2(700),COUNTRY VARCHAR2(700),POSTALCODE VARCHAR(700),ABOUTME VARCHAR2(999),LASTUPDATE DATE);
