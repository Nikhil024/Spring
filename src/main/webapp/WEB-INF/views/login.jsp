...
<body class="index-page">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navigation-index">
				<ul class="nav navbar-nav navbar-right">
					<!-- <li><a href="" target="_blank"> <i class="material-icons">dashboard</i>
							Login
					</a></li> -->
	...
	<div class="wrapper">
		<c:if test="${login=='Farmer Login'}">
			<div class="header header-filter"
				style="background-image: url('<spring:url value="/resources/img/home.jpg"/>');">
		</c:if>
		<c:if test="${login=='Buyer Login'}">
			<div class="header header-filter"
				style="background-image: url('<spring:url value="/resources/img/buyers.jpg"/>');">
		</c:if>
